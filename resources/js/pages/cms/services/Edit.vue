...
const form = useForm({
    ...
    show_in_services: props.service.show_in_services ?? true,
    show_in_pricing: props.service.show_in_pricing ?? false,
    pricing_category: props.service.pricing_category || '',
    pricing_features: props.service.pricing_features || [],
    description: props.service.description || '',
    featured: props.service.featured || null,
    gallery: props.service.gallery || [],
    requirements: props.service.requirements || [],
    cost: props.service.cost || null,
                ...
                <div class="grid gap-6 lg:grid-cols-3">
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <JsonEditor v-model="form.featured" label="" :rows="8" />
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <JsonEditor v-model="form.cost" label="" :rows="6" />
                            </CardContent>
                        </Card>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <JsonEditor v-model="form.gallery" label="" :rows="4" />
                            </CardContent>
                        </Card>
                        ...
                        <Card v-if="form.show_in_pricing">
                            ...
                            <CardContent class="space-y-4">
                                ...
                                <JsonEditor v-model="form.pricing_features" label="Características del precio" :rows="6" />
                            </CardContent>
                        </Card>
                    </div>
                </div>
